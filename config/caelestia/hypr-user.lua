-- Pass mouse button 280 through to Discord / Vesktop (handles press and release automatically)
hl.bind("mouse:280", hl.dsp.pass({ window = "class:^(discord|vesktop)$" }), { ignore_mods = true, non_consuming = true })
...
-- Toggle secondary monitor (DP-1)
hl.bind("SUPER + ALT + M", hl.dsp.exec_cmd(home .. "/.local/bin/toggle-monitor.sh"))
